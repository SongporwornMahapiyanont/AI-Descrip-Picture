...
st.markdown(f'<p style="background-color:#cc6666;color:#ffffff;font-size:150%;text-align:center">{"Created by Songporworn Mahapiyanont"}</p>', unsafe_allow_html=True)
...
img_file = st.file_uploader("openfile")
