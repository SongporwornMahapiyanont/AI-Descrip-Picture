...
prompt = "สิ่งนี้คืออะไร ถ้าคือไข่ไก่มีกี่ฟองและถ้าไม่ใช่ไข่ไก่ไม่ต้องบอกว่ามีกี่ฟอง ถ้าคือเนื้อหมูดูเสียไหมมีประมาณกี่กิโลกรัมเและถ้าไม่ใช่เนื้อหมูไม่ต้องบอกว่ามีกี่กรัม"
