...
prompt = "คืออะไรบอกประเภท มีสีดำขึ้นที่สิ่งของไหมถ้ามีให้บอกว่าเสียและถ้าไม่มีให้บอกว่าไม่เสีย มีจำนวนเท่าไหร่บอกหน่วยด้วยและมีประมาณกี่กิโลกรัมทศนิยมสองตำแหน่งและแช่ในตู้เย็นจะหมดอายุประมาณกี่วันตอบทุกคำถามโดยหน้าคำตอบจะต้องมีคำถามที่ถาม"
