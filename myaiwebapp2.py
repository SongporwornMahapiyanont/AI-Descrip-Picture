...
prompt = "คืออะไรบอกประเภท มีสีดำขึ้นที่สิ่งของไหม มีจำนวนเท่าไหร่บอกหน่วยด้วยและมีประมาณกี่กิโลกรัมทศนิยมสองตำแหน่งและแช่ในตู้เย็นจะหมดอายุประมาณกี่วันตอบทุกคำถามโดยหน้าคำตอยจะต้องมีคำถามที่ถามจัดระเบียบการตอบบนลงล่างให้สวยงาม"
