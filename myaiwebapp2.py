...
prompt = "คืออะไร ถ้ารูปมีสีดำเยอะให้บอกว่าเสียและถ้ามีน้อยไม่ต้องยอกว่าเสีย มีจำนวนเท่าไหร่บอกหน่วยด้วยและมีประมาณกี่กิโลกรัมทศนิยมสองตำแหน่งและแช่ในตู้เย็นจะหมดอายุประมาณกี่วันตอบทุกคำถามโดยจัดระเบียบการตอบบนลงล่างให้สวยงาม"
