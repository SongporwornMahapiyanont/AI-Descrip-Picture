...
prompt = "คืออะไร มีจำนวนเท่าไหร่บอกหน่วยด้วยและมีประมาณกี่กิโลกรัมทศนิยมสองตำแหน่งและแช่ในตู้เย็นจะหมดอายุประมาณกี่วันตอบทุกคำถามโดยจัดระเบียบการตอบบนลงล่างให้สวยงาม ให้ถ่ายรูปเก็บไว้ให้ดูด้วย"
